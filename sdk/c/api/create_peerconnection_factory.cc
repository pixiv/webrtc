...
webrtcCreatePeerConnectionFactory(
  ...
  return rtc::ToC(
      webrtc::CreatePeerConnectionFactory(
          ...
          rtc::ToCplusplus(signaling_thread), rtc::scoped_refptr(rtc::ToCplusplus(default_adm)),
          rtc::scoped_refptr(rtc::ToCplusplus(audio_encoder_factory)),
          rtc::scoped_refptr(rtc::ToCplusplus(audio_decoder_factory)),
          std::unique_ptr<webrtc::VideoEncoderFactory>(
              rtc::ToCplusplus(video_encoder_factory)),
          std::unique_ptr<webrtc::VideoDecoderFactory>(
              rtc::ToCplusplus(video_decoder_factory)),
          rtc::scoped_refptr(rtc::ToCplusplus(audio_mixer)), rtc::scoped_refptr(rtc::ToCplusplus(audio_processing)))
          .release());
}
